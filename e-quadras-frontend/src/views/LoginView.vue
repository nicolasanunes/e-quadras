  ...
  <v-container fluid class="fill-height">
    <v-row class="h-50 justify-center" no-gutters>
      <v-col cols="12" sm="6" md="5" lg="4" xl="3">
        <v-sheet
          elevation="12"
          class="d-flex flex-column fill-height rounded-s justify-center align-center px-16"
        >
          <v-form @submit.prevent class="w-100">
            ...
            >
              <template v-slot:prepend-inner>
                <v-icon size="lg" class="px-4" icon="mdi-email"></v-icon>
              </template>
            </v-text-field>
            ...
            >
              <template v-slot:prepend-inner>
                <v-icon size="lg" class="px-4" icon="mdi-lock"></v-icon>
              </template>
            ...
            <v-btn
              ...
              rounded="pill"
              text="Entrar"
              class="w-100 gradient-background"
      ...
      <v-col cols="12" sm="6" md="5" lg="4" xl="3" class="d-none d-sm-block">
        <v-sheet
          elevation="12"
          class="d-flex flex-column fill-height rounded-e justify-center align-center gradient-background"
        >
          <div class="text-center">
            <v-avatar image="../../../public/icon.png" color="quaternary" size="80"></v-avatar>
            <h2 class="font-weight-regular pt-2">
              Bem-vindo ao
              <strong
                ><a
                  :href="ONWNER_WEBSITE"
